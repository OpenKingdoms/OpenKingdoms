...
[private vulnerability reporting](https://github.com/zbennett10/open-tak/security/advisories/new)
...
OpenTAK parses a lot of untrusted-ish input: game data files, maps, replays
